    ...
    <>
      <Box sx={{ display: "flex" }}>
        ...
        >
          ...
          <TableComponent headings = {headings} array={array} screen="RentalPricingList" />
...
export default AdminRentalPricings;
