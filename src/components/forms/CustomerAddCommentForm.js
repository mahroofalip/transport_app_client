...
import { addCommentAction } from "../../actions/CommonActions";
...
const CustomerAddCommentForm = ({ handleClose, id, customerComments }) => {
...
export default CustomerAddCommentForm;
